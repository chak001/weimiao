...
public class Response<T> implements Serializable {
    ...
    public Response(String msg, String code, T data) {
        this.msg = msg;
        this.code = code;
        this.data = data;
    }
    ...
    //登录效验失败
    public static Response<Void> unauthorized(String msg){
        return new Response<>(msg, FAIL_UNAUTHORIZED);
    }

    //无权限访问接口
    public static Response<Void> unauthorization(String msg){
        return new Response<>(msg, FAIL_UNAUTHORIZATION);
    }

    //TOKEN失效
    public static Response<Void> tokenExpire(String msg){
    ...
    //500异常同意返回
    public static Response<Void> error(String msg, Object info) {
